...
class PetFriends:
    ...
    def get_api_key(self, email: str, password: str) -> json:
        """
        Получение ключа API. Передаёт в заголовках емейл и пароль,
        возвращает код статуса запроса и ключ аутентификации в формате json,
        либо текстом
        """
        headers = {
            'email': email,
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = '') -> json:
        ...
        и значением параметра filter в строке запроса.
        Возвращает статус запроса и список найденных питомцев, совпадающих с фильтром, в формате JSON или в виде текста.
